		...
		<section class="content">
            ...
            <form class="form-horizontal" action="inserisci_sensore_ok.php" method="post">
              <div class="box-body">
				...
				<?php
				echo "<h4>Tipo di sensore - Formato stringa - (Inserire i campi in ordine di posizione nella stringa)</h4>";
				...
				for ($i=1; $i<=$num_campi; $i++){
					...
					if ($num_campi>1) echo "<span style=\"float:left;\"><a href=\"tipo_nuovo.php?campi=" . ($num_campi - 1) . "\">Rimuovi un campo</a></span>";
					echo "<p align=\"right\"><a href=\"tipo_nuovo.php?campi=" . ($num_campi + 1) . "\">Aggiungi un campo</a></p>";
				?>
