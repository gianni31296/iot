      ...
      <div class="col-md-6">
          ...
          <div class="box box-info" style="border-top-color: #00993a;">
            <div class="box-header with-border">
              <h3 class="box-title">Login - Azienda</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="iotscripts/validazione_a.php" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="user" class="col-sm-2 control-label">Utente</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="user" id="username" placeholder="Nome utente">
                  </div>
                </div>
                <div class="form-group">
			  ...
			  <?php if(isset($_SESSION["errore"])) {echo $_SESSION["errore"]; unset($_SESSION["errore"]);}?>
                ...
                <button type="submit" class="btn btn-info pull-right" style="background-color: #00993a; border-color: #00993a">Entra</button>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
